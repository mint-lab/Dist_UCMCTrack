...
def run_ucmc(args, det_path = "det_results/mot17/yolox_x_ablation",
    ...
    print('camera_para = ', cam_para)

    # add noise to camera parameter args.add_cam_noise
    detector = Detector(args.add_cam_noise)
    detector.load(cam_para, det_file, gmc_file, dataset)
